"""
Module: idempotency_writer
Layer: graph
Purpose: Neo4j persistence backend for idempotency records; executes all
         idempotency Cypher queries and maps results to IdempotencyRecord.
Does NOT: decide replay/conflict semantics or open/commit transactions.
Dependencies injected: AsyncSession (per call).
Used by: api.dependency_singletons (injected as IdempotencyStoreProtocol)
"""
