...
from npc_engine.graph.transfer_validators import CurrencyTransferCommand, ItemTransferCommand
from npc_engine.graph.currency_writer import CurrencyTransferWriteResult
from npc_engine.graph.item_writer import ItemTransferWriteResult
...
async def test_apply_currency_transfer_uses_validation_and_atomic_writer(monkeypatch) -> None:
    ...
    monkeypatch.setattr("npc_engine.graph.graph_writer.get_outbound_session_total", fake_get_total)
    monkeypatch.setattr("npc_engine.graph.graph_writer.build_currency_transfer_command", fake_build_command)
    monkeypatch.setattr("npc_engine.graph.graph_writer.transfer_currency_atomic", fake_transfer_atomic)
...
async def test_apply_item_transfer_uses_trading_command_and_atomic_writer(monkeypatch) -> None:
    ...
    monkeypatch.setattr("npc_engine.graph.graph_writer.build_item_transfer_command", fake_build_item_transfer_command)
    monkeypatch.setattr("npc_engine.graph.graph_writer.transfer_item_atomic", fake_transfer_item_atomic)
