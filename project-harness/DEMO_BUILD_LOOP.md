...
- **Phase in progress:** ✅ **PHASES F + G COMPLETE** (modulo deferred F1.6 + F2.3 + G2.2, all gated on DEC-107). Now **Phase H** — **H2 COMPLETE**; only **H3 legacy panels** remain.
- **Current batch:** F + G(sans G2.2) + H0 + H1 + **all of H2 (H2.1–H2.8)** landed. Next candidate: **H3 legacy panels** (the final batch).
- **Last green commit:** `42e3451` feat(H2.7): per-world game_end objectives (demo/village/tavern).
