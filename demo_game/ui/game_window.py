...
Module: game_window
Layer: demo_game.ui
Purpose: Main pygame game window â€” thin coordinator. Owns the event loop and
...
class GameWindow:
    """Main game window â€” event loop and panel coordination.
    ...
    def __init__(self, client: EngineClient, cfg: DemoConfig, window_w: int = 1280, window_h: int = 720) -> None:
        ...
        self._running: bool = True  # mirrored in run() — guards redundant QUIT dispatches

        pygame.init()
        self._screen = pygame.display.set_mode((window_w, window_h))
        pygame.display.set_caption("NPC Engine â€” Demo")
