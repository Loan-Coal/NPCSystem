...
@admin_router.post("/{child_id}/part_of")
...
@admin_router.delete("/{child_id}/part_of/{parent_id}")
...
@read_router.get("/{location_id}/ancestors")
...
@read_router.get("/{location_id}/descendants")
