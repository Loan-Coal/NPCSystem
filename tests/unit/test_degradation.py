...
from npc_engine.api.schemas import ActionModel, DialogueResponse, FacialExpressionModel, RelationDeltas
from npc_engine.engines.dialogue.degradation import (
    DEGRADATION_METRIC,
