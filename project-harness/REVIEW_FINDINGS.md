...
Severity: HIGH · Confidence: Confirmed · **In Progress** (gossip, story_pacing, routine, skill migrated; remaining: idempotency, events, faction_politics, military, quest_generation, clique)
