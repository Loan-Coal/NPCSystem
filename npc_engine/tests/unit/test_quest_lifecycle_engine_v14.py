...
async def test_offer_accept_update_evaluate_and_apply_rewards_happy_path(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "engines.quest.quest_lifecycle_engine.create_quest_state_if_absent",
        fake_create_quest_state_if_absent,
    )
    monkeypatch.setattr("engines.quest.quest_lifecycle_engine.get_quest_state", fake_get_quest_state)
    monkeypatch.setattr("engines.quest.quest_lifecycle_engine.upsert_quest_state", fake_upsert_quest_state)
    monkeypatch.setattr("engines.quest.quest_lifecycle_engine.upsert_quest_lifecycle_event", fake_event_write)
    monkeypatch.setattr("engines.quest.quest_lifecycle_engine.apply_item_transfer", fake_item_transfer)
    monkeypatch.setattr("engines.quest.quest_lifecycle_engine.apply_currency_transfer", fake_currency_transfer)
...
async def test_apply_rewards_emits_provenance_event_with_transaction_support(monkeypatch) -> None:
    ...
    monkeypatch.setattr("engines.quest.quest_lifecycle_engine.upsert_quest_state", fake_upsert_quest_state)
    monkeypatch.setattr("engines.quest.quest_lifecycle_engine.apply_item_transfer", fake_item_transfer)
    monkeypatch.setattr("engines.quest.quest_lifecycle_engine.upsert_quest_lifecycle_event", fake_upsert_event)
...
async def test_offer_rolls_back_state_when_event_write_fails(monkeypatch) -> None:
    ...
    monkeypatch.setattr("engines.quest.quest_lifecycle_engine.upsert_quest_lifecycle_event", failing_event_write)
