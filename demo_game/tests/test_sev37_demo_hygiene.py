...
_POLLER_FILES = [
    _DEMO_ROOT / "gold_poller.py",
    _DEMO_ROOT / "emotion_poller.py",
    _DEMO_ROOT / "game_end_poller.py",
    _DEMO_ROOT / "npc_goals_poller.py",
    _DEMO_ROOT / "npc_needs_poller.py",
    _DEMO_ROOT / "npc_politics_poller.py",
    _DEMO_ROOT / "npc_memory_poller.py",
    _DEMO_ROOT / "world_poller.py",
    _DEMO_ROOT / "world_state_poller.py",
