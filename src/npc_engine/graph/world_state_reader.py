"""
world_state_reader.py - Fetches the singleton WorldState node from Neo4j.
Layer: graph
Purpose: Read the WorldState node and hydrate it into a WorldState model.

Does NOT: update world state values (see graph.world_state_writer).
