...
**[FIXED 2026-06-04] FINDING [SEV-40]: `print()` + hardcoded default API key in `api_seeder.py`** — Confirmed · PY-13, GRAPH-12. 21 `print()` calls (structured-logging rule); `:440` `default=os.environ.get("NPC_API_KEY","local_dev_secret_change_this_2026")` ships a real-looking shared secret. Fix: stdlib logger; require the env var (fail fast). Effort S.
...
- [x] SEV-19 · SEV-20 · SEV-21 · SEV-22 · SEV-40 · SEV-41 — DONE 2026-06-04 (batch fix-parallel run)
