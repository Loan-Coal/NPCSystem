"""
test_dialogue_contract.py - Contract conformance tests for dialogue engine YAML.

Does NOT: execute dialogue engine runtime code.
...
CONTRACT_FILE_NAME = "dialogue_engine.yaml"
CONTRACT_NAME = "dialogue_engine"
...
EXPECTED_TEST_ENTRY = "test_dialogue_contract"


def test_dialogue_contract_has_expected_v14_shape() -> None:
    """Dialogue contract should expose required v1.4 idempotency and auth fields."""
