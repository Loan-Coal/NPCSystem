...
Severity: HIGH · Confidence: Confirmed · **In Progress** (gossip, story_pacing, routine, skill, military, clique migrated; remaining: idempotency, events, faction_politics, quest_generation)
