"""
test_currency_contract.py - Contract conformance tests for currency engine YAML.

Does NOT: execute currency engine runtime code.

Dependencies injected: None.
"""

from tests.engine_contract_tests.contract_test_support import load_contract


CONTRACT_FILE_NAME = "currency_engine.yaml"
CONTRACT_NAME = "currency_engine"
...
EXPECTED_TEST_ENTRY = "test_currency_contract"


def test_currency_contract_has_expected_v14_shape() -> None:
    """Currency contract should expose required v1.4 idempotency and auth fields."""
